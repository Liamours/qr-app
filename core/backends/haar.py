...
No extra dependencies — works everywhere opencv-python-headless is installed.
Landmarks are estimated from the face bounding box, not truly detected.
"""
...
class FaceMesh:
    def __init__(self, max_faces: int = 2, **kwargs) -> None:
        try:
